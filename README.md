...
## Parallel Circuit
This is a demonstration of a simple parallel circuit. I believe parallel circuits are somewhat intriguing. For example, if you replace a 1 ohm light bulb of the parallel part of the circuit with a 3 ohm light bulb, the power consumption of the other light bulb of the parallel circuit will increase. 
